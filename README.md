...
- [Auto Debugger](https://github.com/dudikeleti/auto-debugger) - an early agentic .NET debugging prototype with symbol lookup, source retrieval, runtime probes, HTTP repros, snapshots, diffs, and commits.
